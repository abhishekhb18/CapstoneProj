...
public class Driver {
    ...
    public void setExtent(){
        extent= new ExtentReports(System.getProperty("user.dir")+"/test-output/MedicareExtentReport.html", true);
        extent.addSystemInfo("Host Name", "Abhishek H B");
        extent.addSystemInfo("User Name", "TCS");
